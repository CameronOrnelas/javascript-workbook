...
const evens = strNums.filter(x=> x%2===0);
const sumEvens = (total, num)=>{
  return total + num
}

console.log(nums.reduce(sumEvens))
...
const numCount = nums.reduce((count,num)=>{
...
const atxIdx = array.indexOf('Austin');
